...
See the package [website](https://xiaonixu.github.io/CMAverse/) for a
quickstart guide, an overview of statistical modeling approaches and
examples. For more information on time-to-event mediation analysis, see
this [article](https://xiaonixu.github.io/CMAverse/articles/time_to_event_mediator.html).
...
-   Email <xx2485@cumc.columbia.edu> for questions related to
